...
//    UIView *aView = [[UIView alloc] initWithFrame:CGRectMake(100, 0, 100, 100)];
//    aView.backgroundColor = [UIColor redColor];
//    [self.view addSubview:aView];
//    
//    self.videoCapture.testView = aView;
    
    [self.view addSubview:self.videoCapture.previewView];
    self.videoCapture.previewView.frame = CGRectMake(100, 0, 100, 100);
}

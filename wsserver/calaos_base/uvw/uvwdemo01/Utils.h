...
#define cDebugDom(domain) std::cout
#define cInfoDom(domain) std::cout
#define cWarningDom(domain) std::cout
#define cErrorDom(domain) std::cout
#define cCriticalDom(domain) std::cout
//-----------------------------------------------------------------------------
namespace Utils
{

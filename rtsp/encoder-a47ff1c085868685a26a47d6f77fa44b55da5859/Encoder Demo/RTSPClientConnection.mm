...
- (void) onSocketData:(CFDataRef)data
{
    ...
    if (msg != nil)
    {
        ...
        return;
        if ([cmd caseInsensitiveCompare:@"play"] == NSOrderedSame) {
            //test
...
//                }
                ...
                {
                    [self writeHeader:packet marker:bLast time:0];

...
{
    const char *fname = "/Users/lbb/Desktop/day/rtmp/test.h264";
    ...
    char errbuf[256] = { 0 };
    FILE *fp_yuv = fopen("/Users/lbb/Desktop/day/rtmp/test_out.yuv", "wb+");
...
int CH264Decoder::decode3(uint8_t *pDataIn, int nInSize, uint8_t *pDataOut, int *nWidth, int *nHeight)
{
    ...
    if (packet.size > 0)
    {
        ...
        if (got_picture)
        {
            ...
            char pic[200];
            sprintf(pic,"/Users/lbb/Desktop/day/rtmp/bmp/image%d.bmp",i);
            i++;
...
//
//            tmpImg.save("/Users/lbb/Desktop/day/rtmp/1.jpg", "JPG", 100);
        }
    }
    else
    {
...
int CH264Decoder::test()
{
    ...
    char filepath_in[]="/Users/lbb/Desktop/day/rtmp/bigbuckbunny_480x272.h264";

    
    char filepath_out[]="/Users/lbb/Desktop/day/bigbuckbunny_480x272.yuv";
    int first_time=1;
